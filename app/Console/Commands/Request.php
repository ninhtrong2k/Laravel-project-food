        ...
        if (File::exists($srcFolder)) {
            ...
            if (File::exists($httpFolder)) {
                ...
                if(!File::exists($requestFolder)){
                    File::makeDirectory($requestFolder, 0775, true, true);
                }
                ...
                if (File::exists($requestFolder)) {
                    ...
                    if(!File::exists($requestFolder.'/'.$name.'.php')){
                        ...
                        return $this->info('Request : '.$name.' in Module: '.$module.' created successfully');
                    }else {
                        return $this->error("Request : $name already exists");
                    }
                }
            }
        }
