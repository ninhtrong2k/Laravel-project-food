        ...
        <ul id="accordionSidebar" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUsers"
                    ...
                    <i class="fa-solid fa-user" style="margin-left: 3px;"></i> <span>Users</span>
                </a>
            ...
            <!-- Nav Item - Statistical Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseStatistical"
                    aria-expanded="true" aria-controls="collapseStatistical">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Statistical</span>
                </a>
                <div id="collapseStatistical" class="collapse" aria-labelledby="headingStatistical"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="utilities-color.html">Revenue</a>
                        <a class="collapse-item" href="utilities-border.html">Product</a>
                        <a class="collapse-item" href="utilities-animation.html">Login</a>
                    </div>
                </div>
            </li>
